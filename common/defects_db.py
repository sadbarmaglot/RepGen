...
- Для оценки ширины трещин используй как эталон размеры кирпича: стандартный кирпич имеет ширину 120 мм, длину 250 мм, высоту 65 мм, толщина шва кладки — 10-12 мм. Сравнивай раскрытие трещины с этими размерами для точной оценки в миллиметрах.
- НЕ занижай параметры — оценивай максимально объективно по фото.
- При пограничных значениях (когда оценка параметра близка к границе диапазона) ВСЕГДА выбирай более серьёзный вариант с более высокой категорией дефекта (А серьёзнее Б, Б серьёзнее В).
