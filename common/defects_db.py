DEFECTS_DB = {
                    ...
                    "ranges": [
                        {
                            ...
                            "max": 1,
                            "category": "В",
                            "description": "Трещины в кирпичной кладке стен шириной раскрытия до 1 мм",
                        ...
                        },
                        {
                            ...
                            "max": 5,
                            "category": "Б",
                            "description": "Трещины в кирпичной кладке стен шириной раскрытия до 5 мм",
                        ...
                        },
                        {
                            ...
                            "max": 10,
                            "category": "Б",
                            "description": "Трещины в кирпичной кладке стен шириной раскрытия до 10 мм",
                            "recommendation": "Выполнить усиление кирпичных стен с помощью металлической обоймы. Установить геодезический мониторинг за динамикой развития трещин с помощью пластинчатых маяков и осадочных марок. После условной стабилизации осадки здания (не более 1-2 мм в год) трещины расшить, очистить от слабопрочного материала, произвести зачеканку методом инъекции высокопрочной растворной смесью (как вариант, ЭМАКО S 88С)"
                        },
                        {
                            "code": "STN001_5",
                            "min": 10,
                        ...
                        },
                        {
                            ...
                            "min": 30,
                            "category": "А",
                            "description": "Трещины в кирпичной кладке стен шириной раскрытия более 30 мм",
    ...
    "Инженерные сети": [
        ...
        },
        {
            ...
            "damage_type": "Коррозия трубопроводов водоснабжения",
        ...
        },
        {
            ...
            "damage_type": "Отсутствие/неисправность запорно-регулирующей арматуры",
        ...
        },
        {
            ...
            "damage_type": "Разрушение/отсутствие теплоизоляции трубопроводов",
        ...
        },
        {
            ...
            "damage_type": "Коррозия и износ системы отопления",
        ...
        },
        {
            ...
            "damage_type": "Коррозия/повреждения канализационных трубопроводов",
        ...
        },
        {
            ...
            "damage_type": "Засор/застой в системе канализации",
            ...
            "category": "В",
            "description": "Засоры трубопроводов, застой жидкости с загрязнениями, неисправность отвода, в том числе ливневой канализации",
        ...
        },
        {
            ...
            "damage_type": "Неисправности электропроводки и аппаратуры",
        ...
        },
        {
            ...
            "damage_type": "Неисправность/утрата светильников",
        ...
        },
        {
            ...
            "damage_type": "Неработоспособность/утрата системы вентиляции",
        ...
        },
        {
            ...
            "damage_type": "Разрушение/засорение вентканалов и оголовков шахт",
        ...
        },
        {
            ...
            "damage_type": "Неработоспособность системы дымоудаления",
        ...
        },
        {
            ...
            "damage_type": "Коррозия/повреждение газопроводов и креплений",
        ...
        },
        {
            ...
            "damage_type": "Неработоспособность/утрата пожарной автоматики",
...
CONSTRUCTION_TYPE_ALIASES = {
    "Инженерные сети: система холодного водоснабжения": "Инженерные сети",
    "Инженерные сети: система горячего водоснабжения": "Инженерные сети",
    "Инженерные сети: система водоотведения/канализация": "Инженерные сети",
    "Инженерные сети: система отопления": "Инженерные сети",
    "Инженерные сети: система электроснабжения": "Инженерные сети",
    "Инженерные сети: система дымоудаления": "Инженерные сети",
    "Инженерные сети: система вентиляции": "Инженерные сети",
    "Инженерные сети: система газоснабжения": "Инженерные сети",
    "Инженерные сети: система оповещения о пожаре и пожарной автоматике": "Инженерные сети",
}


def normalize_construction_type(construction_type: str = None) -> str | None:
    """Вернуть имя раздела DEFECTS_DB без изменения старой структуры справочника."""
...
# Кросс-категорийные дефекты — применимы к любой конструкции.
# Источник правды для тегов из DefectType, которые не привязаны к конкретному типу
# конструкции (АКЗ, сварные швы, болтовые соединения, повреждения в узлах).
# Поле `tag` соответствует значению DefectType — по нему делается короткое замыкание
# в эндпоинтах анализа (тег проставлен на метке → ответ из каталога без LLM).
# Формат записи совпадает с DEFECTS_DB (кириллические категории А/Б/В).
CROSS_CUTTING_DEFECTS = [
    ...
    },
    {
        ...
        "recommendation": "Выполнить зачистку сварных соединений и 100% инспекционный УЗ контроль сварных швов. Согласовать данное изменение с проектной организацией, при необходимости усилить стальными накладками, равными по толщине с усиляемыми элементам",
    },
    {
        "code": "SVAR001",
    ...
    },
    {
        ...
        "recommendation": "Чрезмерные наплывы сварных швов нужно удалить механическим способом. Выполнить повторный визуально-измерительный контроль и неразрушающий ультразвуковой контроль. При ремонте сварных соединений оформляют ту же техническую документацию, что и в процессе монтажа металлоконструкций. Работы выполняются без разборки СК, с выполнением поддерживающих мероприятий (кондукторов, струбцин и т.п.) при необходимости",
    },
    {
        "code": "SVAR003",
        ...
        "category": "Б",
        "description": "Участки со следами неполного провара сварных швов. Дефект определён в соответствии с п. 3 ГОСТ 30242-97",
        "recommendation": "Выполнить механизированную зачистку (абразивным инструментом) или механизированной рубкой - с обеспечением плавных переходов в местах выборок. Дефектные участки удалить до «здорового» металла, не оставляя острых углов, и подварить до получения шва нормального размера. Выполнить заварку выборок в соответствии с РД 34.15.132-96. Выполнить повторный визуально-измерительный контроль, и неразрушающий ультразвуковой контроль. При ремонте сварных соединений оформляют ту же техническую документацию, что и в процессе монтажа металлоконструкций. Работы выполняются без разборки СК, с выполнением поддерживающих мероприятий (кондукторов, струбцин и т.п.) при необходимости",
    },
    {
        "code": "SVAR004",
        ...
        "category": "Б",
        "description": "Величина катета сварного соединения элементов не соответствует проектным требованиям и ниже указанных значений",
        "recommendation": "Участки шва с дефектами локально зачистить. Перед повторной сваркой тщательно очистить кромки от ржавчины, окалины, влаги, масла и других загрязнений механическим способом. Переварить дефектные участки в соответствии с требованиями проекта и п. 5.5 ГОСТ 23118-2019. Выполнить повторный визуально-измерительный контроль и неразрушающий ультразвуковой контроль сварного шва. В соответствии с п. 10.5 результаты производственного и приёмочного контроля должны фиксироваться в соответствующих графах журнала сварочных работ",
    },
    {
        "code": "SVAR005",
        ...
        "category": "Б",
        "description": "Поверхностные поры (свищи) в теле сварного шва. Дефект определён в соответствии с п. 3 ГОСТ 30242-97",
        "recommendation": "Выполнить механизированную зачистку (абразивным инструментом) или механизированной рубкой с обеспечением плавных переходов в местах выборок. Дефектные участки удалить до «здорового» металла, не оставляя острых углов, и подварить до получения шва нормального размера. Выполнить заварку выборок в соответствии с РД 34.15.132-96. Выполнить повторный визуально-измерительный контроль и неразрушающий ультразвуковой контроль. При ремонте сварных соединений оформляют ту же техническую документацию, что и в процессе монтажа металлоконструкций. Работы выполняются без разборки СК, с выполнением поддерживающих мероприятий (кондукторов, струбцин и т.п.) при необходимости",
    },
    {
        "code": "SVAR006",
        ...
        "category": "Б",
        "description": "Следы перегрева (натёки, прожоги) сварных швов. Дефект определён в соответствии с п. 3 ГОСТ 30242-97",
        "recommendation": "Выполнить механизированную зачистку (абразивным инструментом) или механизированной рубкой с обеспечением плавных переходов в местах выборок. Дефектные участки удалить до «здорового» металла, не оставляя острых углов, и подварить до получения шва нормального размера. Все ожоги поверхности основного металла сварочной дугой следует зачищать абразивным инструментом на глубину 0,5-0,7 мм. Выполнить заварку выборок в соответствии с РД 34.15.132-96. Выполнить повторный визуально-измерительный контроль и неразрушающий ультразвуковой контроль. При ремонте сварных соединений оформляют ту же техническую документацию, что и в процессе монтажа металлоконструкций. Работы выполняются без разборки СК, с выполнением поддерживающих мероприятий (кондукторов, струбцин и т.п.) при необходимости",
    },
    {
        "code": "SVAR007",
    ...
    },
    {
        ...
        "recommendation": "Очистить элементы от продуктов коррозии, восстановить антикоррозионный слой согласно рекомендациям п. 9.3.7 СП 28.13330.2017",
    },
    {
        "code": "BOLT002",
        "tag": "bolt_deformation",
        "material": "Болты стальные, фланцы стальные, пластины стальные",
        "damage_type": "Болтовые соединения: Деформации в соединении",
        "category": "Б",
        "description": "Деформация (погиб) элемента болтового соединения, что привело к дефекту устройства монтажных болтовых соединений и недостаточной затяжке гаек",
        "recommendation": "Ослабить болтовые соединения, выполнить подгонку сопрягаемых поверхностей (правка) с последующей шлифовкой поверхностей. Стянуть элементы до полного отсутствия щелей в соприкасающихся плоскостях. В случае невозможности выполнения правки, выполнить замену уголка под крепление срезного соединения. Выполнить затяжку болтов до отказа в соответствии с требованиями п. 8.3 СТО НОСТРОЙ 2.10.76-2012. Выполнить контроль плотности стяжки собранного пакета щупом, толщиной 0,3 мм",
    },
    {
        "code": "BOLT003",
        "tag": "bolt_gap",
        "material": "Болты стальные, фланцы стальные",
        "damage_type": "Болтовые соединения: Зазор в соединении",
        "category": "Б",
        "description": "Зазоры в срезных соединениях превышают допустимое значение 0,3 мм в соответствии с п. 4.5.8 СП 70.13330.2012",
        "recommendation": "Выполнить затяжку болтов до отказа в соответствии с требованиями п. 8.3 СТО НОСТРОЙ 2.10.76-2012. Выполнить контроль плотности стяжки собранного пакета щупом, толщиной 0,3 мм",
    },
    {
        "code": "BOLT004",
        "tag": "bolt_incomplete_set",
        "material": "Болты стальные, гайки стальные, контргайки стальные",
        "damage_type": "Болтовые соединения: Некомплектность пакета",
        "category": "Б",
        "description": "Отсутствие контргайки болтового соединения",
        "recommendation": "Выполнить монтаж контргаек. Выполнить затяжку болтов до отказа в соответствии с требованиями п. 8.3 СТО НОСТРОЙ 2.10.76-2012. Выполнить контроль плотности стяжки собранного пакета щупом, толщиной 0,3 мм",
    },
    {
        "code": "BOLT005",
        ...
        "recommendation": "Выполнить развинчивание болтового соединения. Установить новые элементы (болты и гайки) необходимого диаметра в соответствии с проектом. Выполнить затяжку болтов до отказа в соответствии с требованиями п. 8.3 СТО НОСТРОЙ 2.10.76-2012. Выполнить контроль плотности стяжки собранного пакета щупом, толщиной 0,3 мм",
    },
    {
        "code": "BOLT006",
        "tag": "bolt_nut_loosening",
        "material": "Болты стальные, гайки стальные",
        "damage_type": "Болтовые соединения: Откручивание гайки",
        "category": "Б",
        "description": "Болты имеют зазоры и не плотно соприкасаются с плоскостями шайб и элементов конструкций",
        "recommendation": "Выполнить затяжку болтов до отказа в соответствии с требованиями п. 8.3 СТО НОСТРОЙ 2.10.76-2012. Выполнить контроль плотности стяжки собранного пакета щупом, толщиной 0,3 мм",
    },
    {
        "code": "BOLT007",
        ...
        "recommendation": "Установить новые элементы (болты и гайки) необходимого диаметра в соответствии с проектом. Выполнить затяжку болтов до отказа в соответствии с требованиями п. 8.3 СТО НОСТРОЙ 2.10.76-2012. Выполнить контроль плотности стяжки собранного пакета щупом, толщиной 0,3 мм",
    },
    {
        "code": "BOLT008",
    ...
    },
    {
        ...
        "material": "Фланцы стальные и болты стальные",
        "damage_type": "Болтовые соединения: Фланцы различной толщины",
        "category": "В",
        "description": "Во фланцевых соединениях местами применены фланцы различной толщины и отличной толщины от проектных значений, но не менее проектных значений",
        "recommendation": "Данное отступление от требований проектной документации не оказывает влияния на несущую способность здания. Допускается оставить данный дефект без изменений",
    },
]


def get_defect_by_tag(tag: str) -> dict | None:
    """
    Получить запись кросс-категорийного дефекта по тегу (значению DefectType).

    Используется для короткого замыкания в эндпоинтах анализа: если у метки
    проставлен один из кросс-категорийных тегов, ответ берётся из каталога
    напрямую, без обращения к LLM. Категория возвращается в том же виде,
    что и в DEFECTS_DB (кириллическая А/Б/В) — нормализация выполняется
    в сервисном слое через CATEGORY_INPUT_MAP.
    """
    if not tag:
        return None
...
def _build_code_index():
    ...
    # Кросс-категорийные дефекты — без привязки к construction_type
    for defect in CROSS_CUTTING_DEFECTS:
...
def _tags_str(defect: dict) -> str:
    tags = defect.get("tags") or defect.get("tags_list") or defect.get("tag") or []
    return ", ".join(tags) if isinstance(tags, (list, tuple)) else str(tags)


def _visual_str(defect: dict) -> str:
    return defect.get("visual_signs", "")


def _recognition_prompt_fields(defect: dict) -> str:
    fields = []
    visual = _visual_str(defect)
    tags = _tags_str(defect)
    if visual:
        fields.append(f"visual_signs: {visual};")
    if tags:
...
def get_defects_text(construction_type: str = None) -> str:
    ...
    Теперь включает коды дефектов, а при наличии — визуальные признаки и теги.
    """
    defects_list = []
    normalized_type = normalize_construction_type(construction_type)
    if normalized_type and normalized_type in DEFECTS_DB:
        defects_list = list(DEFECTS_DB[normalized_type])
    else:
    ...
    # Кросс-категорийные дефекты (АКЗ, узлы, сварные швы, болтовые соединения)
    # подмешиваются к любой конструкции — они не привязаны к типу.
    defects_list.extend(CROSS_CUTTING_DEFECTS)

    result_lines = []

    for defect in defects_list:
        code = defect.get("code", "")
        recognition_fields = _recognition_prompt_fields(defect)
                ...
                if param_config.get("type") == "range" and "ranges" in param_config:
                    ...
                    for range_item in param_config["ranges"]:
                        ...
                        if variant_code:
                            ...
                            line = f"code: {variant_code};{range_str} description: {range_item.get('description', '')};{recognition_fields} recommendation: {range_item.get('recommendation', '')}; category: {range_item.get('category', '')}; material: {defect.get('material', '')}."
                            result_lines.append(line)
        else:
            # Дефект без параметров
            line = f"code: {code}; description: {defect['description']};{recognition_fields} recommendation: {defect['recommendation']}; category: {defect['category']}; material: {defect.get('material', '')}."
            result_lines.append(line)
...
3. На основе оценённых параметров выбери наиболее подходящий дефект из базы, обращая внимание на визуальные признаки, теги и диапазоны параметров (min/max).
