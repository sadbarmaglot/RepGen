...
2. Найди наиболее подходящий дефект из базы.
3. Верни КОД этого дефекта.

ВАЖНО:
- Верни ТОЛЬКО код дефекта из базы (например "STN008_1", "KRV002", "FND001").
- Если дефект имеет варианты с разными параметрами (например, глубина разрушения, ширина трещины), выбери подходящий вариант и верни его код.
- НЕ генерируй текст описания сам — только код!
